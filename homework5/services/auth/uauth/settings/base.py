...
PROFILES_SERVICE = os.environ.get('PROFILES_SERVICE', 'profiles')
PROFILES_PORT = os.environ.get('PROFILES_PORT', 8001)
PROFILES_URL = f'http://{PROFILES_SERVICE}:{PROFILES_PORT}/api/internal/profiles/'
